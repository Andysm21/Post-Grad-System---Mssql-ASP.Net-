<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GUCIAN.aspx.cs" Inherits="MS3.GUCIAN" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Label ID="Label1" runat="server" Text="GUCIAN PAGE"></asp:Label>
           <br />
                ...
                <asp:TableRow>
                    <asp:TableCell ColumnSpan ="5">
                        ...
                        <asp:Button ID="Button2" runat="server" OnClick="ListTheses" Text="My Theses"/>
                         ...
                         <asp:Button ID="Button5" runat="server" Text="Add Phone Number" OnClick="AddPhone" />
